...
build(FILE *f, Lexicon *l, char *name, char *srcpath)
{
	...
	fputs("<footer><hr />", f);
	fpedited(f, srcpath);
	fputs("<b>Rek Bell</b> © 2008-2024 <a href='http://webring.xxiivv.com/#random'>[Webring]</a> <a href='https://merveilles.town/@rek'>[Masto]</a> <a href='politics.html'>[Politics]</a> <a href='index.html'>[Index]</a> <a href='links.html'>[Links]</a> — ", f);
